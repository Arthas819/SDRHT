"""
    This file provides estimators for log-det-Hessian and its gradient. 

    Proposed by Huang et al. (2020), https://arxiv.org/abs/2012.05942

    Copy from https://github.com/CW-Huang/CP-Flow
"""

#     eigvals, eigvecs = torch.symeig(T, eigenvectors=True) -> eigvals, eigvecs = torch.linalg.eigh(T)
...
def stochastic_quadrature(T, dim, func=torch.log):
    ...
    # eigvals = eigvals.clamp(min=1e-2)
